odoo.define('shams_dtp.main', function(require) {
  ...
  datepicker.DateWidget.include({
        events: {},
            start: function() {
                    ...
                    var i;
                    for (i = 600; i < 5000; i++) {
                    this.$input = this.$('input.oe_datepicker_control');
                    this.$('#o_field_input_'+i+'1').MdPersianDateTimePicker({
                        targetDateSelector: 'input[data-target="o_field_input_'+i+'"]',
                        targetTextSelector: '#o_field_input_'+i+'3',
              ...
              console.log("lpolpolpl");
                this.$getScript = this.$("picker.js", function(data, textStatus, jqxhr) {
                    var self = this;
                self.console.log(data); //data returned
                self.console.log(textStatus); //success
                self.console.log(jqxhr.status); //200
                self.console.log('Load was performed.');
                });
